    ...
    public partial class MigrationName : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Achievem__833913348EB6F7EC", x => x.achievements_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    time_create = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())"),
                    end_time = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Dialogs__39AA56DBD0F42E0C", x => x.dialogs_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6ED9C4445BF", x => x.ProductID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Roles__3213E83F24C91117", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Schedule__C46A8A6F001C1753", x => x.schedule_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    training_id = table.Column<int>(type: "int", nullable: false),
                    TrainingDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Training__3213E83F5D0AC0A2", x => x.id);
                    table.UniqueConstraint("AK_Training_training_id", x => x.training_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Users__B9BE370FE477DE7B", x => x.user_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Nutritio__147CC3A2A62ED9EB", x => x.nutrition_id);
                    table.ForeignKey(
                        name: "FK_Nutration",
                        column: x => x.Product,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    comments_date = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Comments__E059CA99DC324E18", x => x.comments_id);
                    table.ForeignKey(
                        name: "FK_Comments",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Friend__3FA1E155FC17435C", x => x.friend_id);
                    table.ForeignKey(
                        name: "FK_Friend_1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Groups__54CA4F67F69A76BB", x => x.groups_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date_message = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())"),
                    date_up_message = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__MessageU__C87C037C291336D8", x => x.MessageID);
                    table.ForeignKey(
                        name: "FK_Message_1",
                        column: x => x.SenderID,
                        principalTable: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PhotoUse__21B7B582ECEDE671", x => x.PhotoID);
                    table.ForeignKey(
                        name: "Fk_PhotoUser",
                        column: x => x.user_id,
                        principalTable: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Publicat__CE2F37DC8509188E", x => x.publications_id);
                    table.ForeignKey(
                        name: "FK_Publication",
                        column: x => x.users_id,
                        principalTable: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true, defaultValueSql: "(NULL)"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Trainer__65A4B6291F5BDAC1", x => x.trainer_id);
                    table.ForeignKey(
                        name: "FK_Trainer",
                        column: x => x.user_id,
                        principalTable: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<int>(type: "int", nullable: false),
                    achievements_id = table.Column<int>(type: "int", nullable: false),
                    get_date_achievements = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__User_to___3213E83F7A3F286E", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__User_to___3213E83FB22E8262", x => x.id);
                    table.ForeignKey(
                        name: "FK_Dialogs",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__User_to___3213E83F58C53065", x => x.id);
                    table.ForeignKey(
                        name: "FK_role",
                        column: x => x.user_id,
                        principalTable: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserNutr__53483C7181425DBD", x => x.user_nutrition_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__GroupMem__54CA4F6771C540AD", x => x.groups_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Trainers__3213E83F928DF0C8", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    start_at = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())"),
                    end_at = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "(getdate())"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__UserTrai__3213E83F139E5454", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Comments__E059CA982AFBB896",
                table: "Comments",
                column: "comments_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Friend__3FA1E1544E786DC0",
                table: "Friend",
                column: "friend_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Friend__7482DAF0E16D9C14",
                table: "Friend",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Groups__FEBE0EE76EE8C9F0",
                table: "Groups",
                column: "owner_groups",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Products__A2A64E92A9A004B0",
                table: "Products",
                column: "Product",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Publicat__CE2F37DD2ABCC851",
                table: "Publication",
                column: "publications_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UQ__Roles__3213E83EE86A8FB9",
                table: "Roles",
                column: "id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Trainer__8E3F5558B9A95249",
                table: "Trainer",
                columns: new[] { "trainer_id", "user_id" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Training__2F28D08ED07AEC33",
                table: "Training",
                column: "training_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__User_to___3213E83E415D1963",
                table: "User_to_rule",
                column: "id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Users__B9BE370E5A3ABD8E",
                table: "Users",
                column: "user_id",
                unique: true);
